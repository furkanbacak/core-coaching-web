...
export async function generateMetadata() {
  const t = await getTranslations('coachingSchool.level2');
...
export default async function Level2Page({
  ...
  const tLevel = await getTranslations('coachingSchool.level2');
      ...
      <main className="min-h-screen bg-neutral-50">
        ...
        <section className="relative -mt-16 pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl p-12 md:p-16 shadow-xl shadow-neutral-200/50 border border-neutral-100 flex flex-col items-center justify-center min-h-[280px]">
